...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/crawler_dev/helpers/` and `examples/` directory.
...
require_relative "../lib/crawler_dev"
...
```ruby
gem "crawler.dev", git: "https://www.github.com/stainless-sdks/crawler.dev-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/crawler.dev-ruby' '<path-to-repo>'
```

```ruby
gem "crawler.dev", path: "<path-to-repo>"
```

    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { CrawlerDev::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { CrawlerDev::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            CrawlerDev::FilePart.new(value)
          in CrawlerDev::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in CrawlerDev::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [CrawlerDev::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: CrawlerDev::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in CrawlerDev::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in CrawlerDev::Internal::Type::Converter
              ...
              CrawlerDev::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(CrawlerDev::Internal::Type::Converter, T::Class[T.anything]) }
        end

      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - CrawlerDev::Internal::Util.monotonic_secs
          ...
          def build_request(request, &blk)
            ...
            in String
              ...
              req.body_stream = CrawlerDev::Internal::Util::ReadIOAdapter.new(body, &blk)
            in StringIO
        ...
        private def with_pool(url, deadline:, &blk)
          origin = CrawlerDev::Internal::Util.uri_origin(url)
          timeout = deadline - CrawlerDev::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise CrawlerDev::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise CrawlerDev::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          _, response = enum.next
          body = CrawlerDev::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            loop { enum.next }
          ensure
            closing&.call

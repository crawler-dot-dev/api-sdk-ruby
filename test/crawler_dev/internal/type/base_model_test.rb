...
class CrawlerDev::Test::PrimitiveModelTest < Minitest::Test
  A = CrawlerDev::Internal::Type::ArrayOf[-> { Integer }]
  H = CrawlerDev::Internal::Type::HashOf[-> { Integer }, nil?: true]

  module E
    extend CrawlerDev::Internal::Type::Enum
  end

  module U
    extend CrawlerDev::Internal::Type::Union
  end

  class B < CrawlerDev::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      CrawlerDev::Internal::Type::Unknown,
      CrawlerDev::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => CrawlerDev::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [CrawlerDev::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [CrawlerDev::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [CrawlerDev::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = CrawlerDev::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        CrawlerDev::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [CrawlerDev::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [CrawlerDev::Internal::Type::Boolean, true] => true,
      [CrawlerDev::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => CrawlerDev::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        CrawlerDev::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = CrawlerDev::Internal::Type::Converter.new_coerce_state
      CrawlerDev::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        CrawlerDev::Internal::Type::Converter.dump(target, input, state: state)
...
class CrawlerDev::Test::EnumModelTest < Minitest::Test
  class E0
    include CrawlerDev::Internal::Type::Enum
...
class CrawlerDev::Test::CollectionModelTest < Minitest::Test
  A1 = CrawlerDev::Internal::Type::ArrayOf[-> { Integer }]
  H1 = CrawlerDev::Internal::Type::HashOf[Integer]

  A2 = CrawlerDev::Internal::Type::ArrayOf[H1]
  H2 = CrawlerDev::Internal::Type::HashOf[-> { A1 }]

  A3 = CrawlerDev::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = CrawlerDev::Internal::Type::HashOf[Integer, nil?: true]
...
class CrawlerDev::Test::BaseModelTest < Minitest::Test
  class M1 < CrawlerDev::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < CrawlerDev::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < CrawlerDev::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, CrawlerDev::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = CrawlerDev::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = CrawlerDev::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(CrawlerDev::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue CrawlerDev::Errors::ConversionError => e
...
class CrawlerDev::Test::UnionTest < Minitest::Test
  class U0
    include CrawlerDev::Internal::Type::Union
  ...
  class M2 < CrawlerDev::Internal::Type::BaseModel
  ...
  class M4 < CrawlerDev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, CrawlerDev::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < CrawlerDev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, CrawlerDev::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class CrawlerDev::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include CrawlerDev::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [CrawlerDev::Internal::Type::Unknown, CrawlerDev::Internal::Type::Unknown] => true,
      [CrawlerDev::Internal::Type::Boolean, CrawlerDev::Internal::Type::Boolean] => true,
      [CrawlerDev::Internal::Type::Unknown, CrawlerDev::Internal::Type::Boolean] => false,
...
class CrawlerDev::Test::MetaInfoTest < Minitest::Test
  A1 = CrawlerDev::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = CrawlerDev::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
